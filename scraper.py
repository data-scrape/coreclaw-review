#!/usr/bin/env python3
"""
coreclaw-review - CoreClaw CoreClaw API Demo
...
def main():
    parser = argparse.ArgumentParser(description="coreclaw-review - CoreClaw CoreClaw API Demo")
    ...
    client = CoreclawReview(api_key=args.api_key)
